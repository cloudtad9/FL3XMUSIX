...
#include "../../ckeybind/keybind.h"

namespace drankdrankdrank
{
	namespace offsets
	{
	...
	namespace roblox
	{
		...
		public:
			...
			std::vector<drankdrankdrank::roblox::instance_t> children();
			drankdrankdrank::roblox::instance_t find_first_child(std::string child);
			drankdrankdrank::roblox::instance_t find_first_child_of_class(std::string child);

			/* decided to have everything in one class rather than have multiple, it will be harder to manage (im lazy) */

			drankdrankdrank::roblox::instance_t get_local_player();
			drankdrankdrank::roblox::instance_t get_model_instance();
			drankdrankdrank::roblox::instance_t get_team();

			drankdrankdrank::roblox::vector2_t get_dimensions();
			drankdrankdrank::roblox::matrix4_t get_view_matrix();
			drankdrankdrank::roblox::vector3_t get_camera_pos();
			drankdrankdrank::roblox::vector3_t get_part_pos();
			drankdrankdrank::roblox::vector3_t get_part_velocity();
			...
			bool get_value_bool();
			int get_value_int();
			drankdrankdrank::roblox::matrix3_t get_camera_cframe();
			drankdrankdrank::roblox::vector3_t get_value_vector3();
		};

		drankdrankdrank::roblox::vector2_t world_to_screen(drankdrankdrank::roblox::vector3_t world);
	}
}